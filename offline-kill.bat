@echo off
echo Computrace Kill Script V1.0 - Kippykip, modified to run offline by billypurdue
echo This is intended to be run from within Sergei Strelec's WinPE, and will fail otherwise!
echo You can get it here: https://www.majorgeeks.com/files/details/sergei_strelecs_winpe.html
echo:
...
Reg.exe add "HKLM\SYSTEM\ControlSet001\services\Ctes Manager" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet001\services\CtesHostSvc" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet001\services\rpchdp" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet001\services\rpcnet" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet001\services\rpcnetp" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet002\services\CscService" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet002\services\Ctes Manager" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet002\services\CtesHostSvc" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet002\services\rpchdp" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet002\services\rpcnet" /v "Start" /t REG_DWORD /d "4" /f

Reg.exe add "HKLM\SYSTEM\ControlSet002\services\rpcnetp" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\SYSTEM\ControlSet002\Control\Session Manager" /v DisableWpbtExecution /t REG_DWORD /d "1" /f
